...
#ifdef _DEBUG
#pragma  comment(lib, "SDL2maind.lib") // SDL2main.lib
#else
#pragma  comment(lib, "SDL2main.lib") // SDL2main.lib
#endif
...
static int stream_component_open(VideoState* is, int stream_index)
{
    ...
    AVChannelLayout ch_layout = { AV_CHANNEL_ORDER_NATIVE, 2, 3 };
    int ret = 0;
